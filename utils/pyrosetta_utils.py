...
if ((psutil.virtual_memory().total / (1024 ** 3)) > 32):
    import pyrosetta
    print("PyRosetta successfully imported. Your system has sufficient memory to run PyRosetta.")
else:
    print("PyRosetta requires at least 32GB of RAM. Please check your system's memory and try again.")
